...
export class DbPopulateService implements OnApplicationBootstrap {
    ...
    readonly #oracleInsertFilm = `
        INSERT INTO film(id,version,bewertung,genre,preis,datum,erzeugt,aktualisiert)
        SELECT id,version,bewertung,genre,preis,datum,erzeugt,aktualisiert
        FROM   EXTERNAL (
            (id            NUMBER(10,0),
            version       NUMBER(3,0),
            bewertung        NUMBER(1,0),
            genre           VARCHAR2(12),
            preis         NUMBER(8,2),
            datum         DATE,
            erzeugt       TIMESTAMP,
            ...
            ACCESS PARAMETERS (
                ...
                (id,version,bewertung,genre,preis,
    ...
    readonly #oracleInsertTitel = `
        INSERT INTO titel(id,titel,beschreibung,film_id)
        SELECT id,titel,beschreibung,film_id
        FROM   EXTERNAL (
            (id         NUMBER(10,0),
            titel       VARCHAR2(40),
